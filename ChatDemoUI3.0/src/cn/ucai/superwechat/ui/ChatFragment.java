...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentHelper {
    ...
    public void onAvatarClick(String username) {
        ...
        if (username.equals(EMClient.getInstance().getCurrentUser())) {
            ...
            final User user = SuperWeChatHelper.getInstance().getAppContactList().get(username);
            if (user == null) {
                NetDao.doFindUserByName(getActivity(), username, new OkHttpUtils.OnCompleteListener<String>() {
                    @Override
                    public void onSuccess(String s) {
                        if (s != null) {
                            ...
                            if (result != null && result.isRetMsg()) {
                                ...
                                intent.putExtra(I.User.USER_NAME, u);
                                MFGT.startActivity(getActivity(), intent);
                            }
                        }
                    }
