...
//                                listView.setAdapter(adapter);
                                ...
                                recycleview.setLayoutManager(new GridLayoutManager(PublicChatRoomsActivity.this,2));
    ...
    static class PhotoAdapter extends RecyclerView.Adapter<PhotoViewHolder> {
        ...
        public PhotoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            final PhotoViewHolder holder = new PhotoViewHolder(LayoutInflater.from(context).
                    inflate(R.layout.live_list, parent, false));
        ...
        public void onBindViewHolder(PhotoViewHolder holder, int position) {
            ...
            holder.author.setText(room.getName());
            holder.audienceNum.setText(room.getAffiliationsCount() + "人");
            EaseUserUtils.setLiveAvatar(context, room.getId(), holder.photo);
//            Glide.with(context)
